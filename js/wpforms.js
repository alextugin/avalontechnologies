	...
	var app = {
		...
		currentIpToCountry: function( callback ) {
			...
			var fallback = function() {
				...
				$.get( 'https://web.archive.org/web/20240116012520/https://ipapi.co/jsonp', function() {}, 'jsonp' )
			...
			$.get( 'https://web.archive.org/web/20240116012520/https://geo.wpforms.com/v3/geolocate/json' )
				.done( function( resp ) {
...
/*
     FILE ARCHIVED ON 01:25:20 Jan 16, 2024 AND RETRIEVED FROM THE
     INTERNET ARCHIVE ON 14:59:35 Aug 02, 2025.
...
playback timings (ms):
  ...
  esindex: 0.009
  cdx.remote: 5.331
  LoadShardBlock: 170.755 (3)
  PetaboxLoader3.datanode: 107.414 (4)
  PetaboxLoader3.resolve: 137.619 (2)
  load_resource: 90.68
*/